        ...
        <div className="user-doc-bg py-5">
            <div className="container">
                ...
                {loading ? (
                    ...
                    <p className="text-center text-muted">No doctors available in {selectedSpecialization || "this category"} right now.</p>
                ) : (
                ...
                <div className="text-center mt-5">
                    ...
                    <p className="text-muted">
                        Trusted, experienced, and verified doctors are here to help you 24/7. 
                        Get personalized advice from the comfort of your home.
                    </p>
                    <img
